  ...
  const experience = [
    {
      ...
      logo: capital,
      points: [
        "Led statutory audits and assurance engagements for entities across trading, services, manufacturing, real estate, and investment sectors, ensuring compliance with International Standards on Auditing (ISA) and applicable UAE regulatory requirements.",
        "Planned and executed audit engagements from risk assessment through completion, including materiality determination, substantive testing, analytical review procedures, and evaluation of internal controls.",
        "Prepared and reviewed complete sets of financial statements in accordance with International Financial Reporting Standards (IFRS), including disclosures, accounting policies, estimates, and management judgments.",
        "Evaluated and implemented IFRS requirements, including IFRS 16 Leases, IFRS 9 Financial Instruments, IAS 36 Impairment of Assets, IAS 37 Provisions, and IFRS 15 Revenue from Contracts with Customers.",
        "Performed lease accounting assessments under IFRS 16, including recognition and measurement of right-of-use assets, lease liabilities, discount rate calculations, and preparation of related disclosures.",
        "Assessed expected credit loss (ECL) provisions and financial asset classifications under IFRS 9, including review of receivables aging, impairment indicators, and management assumptions.",
        "Prepared and reviewed audit working papers, audit planning memoranda, risk assessment documentation, management letters, representation letters, engagement letters, and independent auditor’s reports.",
        "Assisted clients with UAE Corporate Tax compliance, including tax computations, identification of deductible and non-deductible expenses, Qualifying Free Zone Person (QFZP) assessments, and preparation of supporting documentation.",
        "Managed Value Added Tax (VAT) compliance engagements, including VAT return preparation, reconciliations, transaction reviews, VAT health checks, and advisory on UAE VAT regulations.",
        "Conducted analytical reviews of financial information, cash flow forecasts, budgets, and management accounts to identify unusual trends, financial risks, and areas requiring further audit attention.",
        "Coordinated directly with client management and finance teams to resolve accounting issues, strengthen internal controls, and improve financial reporting processes and regulatory compliance.",
        "Supervised audit teams, reviewed staff work, ensured adherence to audit methodologies, and managed engagement timelines to meet reporting deadlines and client expectations.",
      ],
    },
    {
    ...
    },
    {
      ...
      logo: ndf,
      points: [
        "Processed expense bookings, journal vouchers, and bank payment transactions for operational expenditures, including rent, advertising, and vendor payments." ,
        "Recorded financial transactions in Oracle ERP using double-entry accounting principles and maintained supporting documentation for accounting records.",
        "Assisted in monthly account reconciliations, ensuring the accuracy and completeness of ledger balances and financial records.",
        "Participated in physical inventory counts and stock verification exercises, investigating variances and supporting inventory control procedures.",  
        "Reviewed supplier invoices, payment requests, and supporting documents to ensure compliance with company policies and authorization procedures.",  
        "Assisted in the preparation of management reports and schedules by compiling financial data and performing basic analytical reviews.",  
      ],
    },
  ];
