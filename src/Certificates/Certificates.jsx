...
const projects = [
  ...
  },
  {
    ...
    category: "ICAP",
    image: certi7,
    summary: "Modern data handling, Power BI, DAX, Python, and ETL processes for CA professionals.",
    bullets: [
  ...
  {
    title: "Writing Skills and Presentation",
    issuer: "ICAP",
    category: "ICAP",
    image: certi8,
    summary: "Enhancing clarity, accuracy, and confidence in written and verbal business communication.",
    bullets: [
      "Techniques for professional, concise, reader-focused report writing.",
      "Clear structure, tone, and formatting for effective business correspondence.",
      "Presentation skills including audience analysis, visual aids, and confident delivery.",
      "Practice through simulated board-level reports and live presentation exercises.",
    ],
    link: "/writing.pdf",
  },
